...
extern "C" __declspec(dllexport) void __stdcall GetProjectionCTF(PseudoProjectorPTR proj, float* output, float* output_nrm, DOUBLE * GaussTables, DOUBLE * GaussTables2, float3 angles, float shiftX, float shiftY, unsigned int batch);
...
extern "C" __declspec(dllexport) float __stdcall DoARTStepMovedCTF(PseudoProjectorPTR proj, DOUBLE * Iexp, float3 * angles, float *atomPositions, DOUBLE * GaussTables, DOUBLE * GaussTables2, DOUBLE shiftX, DOUBLE shiftY, unsigned int numImages);
...
extern "C" __declspec(dllexport) float __stdcall DoARTStepCTF(PseudoProjectorPTR proj, DOUBLE * Iexp, float3 * angles, DOUBLE * GaussTables, DOUBLE * GaussTables2, DOUBLE shiftX, DOUBLE shiftY, unsigned int numImages);
