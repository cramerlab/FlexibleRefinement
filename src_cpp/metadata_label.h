...
enum EMDLabelType
{
	EMDL_INT, EMDL_BOOL, EMDL_RDOUBLE, EMDL_STRING, EMDL_RDOUBLE_VECTOR, EMDL_UNKNOWN
};
...
private:
	StaticInitialization()
	{
		...
		EMDL::addLabel(EMDL_BODY_ROTATE_DIRECTION_X, EMDL_RDOUBLE, "rlnBodyRotateDirectionX", "X-component of axis around which to rotate this body");
		EMDL::addLabel(EMDL_BODY_ROTATE_DIRECTION_Y, EMDL_RDOUBLE, "rlnBodyRotateDirectionY", "Y-component of axis around which to rotate this body");
		EMDL::addLabel(EMDL_BODY_ROTATE_DIRECTION_Z, EMDL_RDOUBLE, "rlnBodyRotateDirectionZ", "Z-component of axis around which to rotate this body");
		...
		EMDL::addLabel(EMDL_BODY_SIGMA_ANG, EMDL_RDOUBLE, "rlnBodySigmaAngles", "Width of prior on all three Euler angles of a body in multibody refinement (in degrees)");
		EMDL::addLabel(EMDL_BODY_SIGMA_OFFSET, EMDL_RDOUBLE, "rlnBodySigmaOffset", "Width of prior on origin offsets of a body in multibody refinement (in pixels)");
		EMDL::addLabel(EMDL_BODY_SIGMA_OFFSET_ANGSTROM, EMDL_RDOUBLE, "rlnBodySigmaOffsetAngst", "Width of prior on origin offsets of a body in multibody refinement (in Angstroms)");
		EMDL::addLabel(EMDL_BODY_SIGMA_ROT, EMDL_RDOUBLE, "rlnBodySigmaRot", "Width of prior on rot angles of a body in multibody refinement (in degrees)");
		EMDL::addLabel(EMDL_BODY_SIGMA_TILT, EMDL_RDOUBLE, "rlnBodySigmaTilt", "Width of prior on tilt angles of a body in multibody refinement (in degrees)");
		EMDL::addLabel(EMDL_BODY_SIGMA_PSI, EMDL_RDOUBLE, "rlnBodySigmaPsi", "Width of prior on psi angles of a body in multibody refinement (in degrees)");
		EMDL::addLabel(EMDL_BODY_STAR_FILE, EMDL_STRING, "rlnBodyStarFile", "Name of STAR file with body masks and metadata");

		EMDL::addLabel(EMDL_CTF_ASTIGMATISM, EMDL_RDOUBLE, "rlnCtfAstigmatism", "Absolute value of the difference between defocus in U- and V-direction (in A)");
		EMDL::addLabel(EMDL_CTF_BFACTOR, EMDL_RDOUBLE, "rlnCtfBfactor", "B-factor (in A^2) that describes CTF power spectrum fall-off");
		EMDL::addLabel(EMDL_CTF_MAXRES, EMDL_RDOUBLE, "rlnCtfMaxResolution", "Estimated maximum resolution (in A) of significant CTF Thon rings");
		EMDL::addLabel(EMDL_CTF_VALIDATIONSCORE, EMDL_RDOUBLE, "rlnCtfValidationScore", "Gctf-based validation score for the quality of the CTF fit");
		EMDL::addLabel(EMDL_CTF_SCALEFACTOR, EMDL_RDOUBLE, "rlnCtfScalefactor", "Linear scale-factor on the CTF (values between 0 and 1)");
		EMDL::addLabel(EMDL_CTF_VOLTAGE, EMDL_RDOUBLE, "rlnVoltage", "Voltage of the microscope (in kV)");
		EMDL::addLabel(EMDL_CTF_DEFOCUSU, EMDL_RDOUBLE, "rlnDefocusU", "Defocus in U-direction (in Angstroms, positive values for underfocus)");
		EMDL::addLabel(EMDL_CTF_DEFOCUSV, EMDL_RDOUBLE, "rlnDefocusV", "Defocus in V-direction (in Angstroms, positive values for underfocus)");
		EMDL::addLabel(EMDL_CTF_DEFOCUS_ANGLE, EMDL_RDOUBLE, "rlnDefocusAngle", "Angle between X and defocus U direction (in degrees)");
		EMDL::addLabel(EMDL_CTF_CS, EMDL_RDOUBLE, "rlnSphericalAberration", "Spherical aberration (in millimeters)");
		EMDL::addLabel(EMDL_CTF_CA, EMDL_RDOUBLE, "rlnChromaticAberration", "Chromatic aberration (in millimeters)");
		EMDL::addLabel(EMDL_CTF_DETECTOR_PIXEL_SIZE, EMDL_RDOUBLE, "rlnDetectorPixelSize", "Pixel size of the detector (in micrometers)");
		EMDL::addLabel(EMDL_CTF_POWER_SPECTRUM, EMDL_STRING, "rlnCtfPowerSpectrum", "Power spectrum for CTF estimation");
		EMDL::addLabel(EMDL_CTF_ENERGY_LOSS, EMDL_RDOUBLE, "rlnEnergyLoss", "Energy loss (in eV)");
		EMDL::addLabel(EMDL_CTF_FOM, EMDL_RDOUBLE, "rlnCtfFigureOfMerit", "Figure of merit for the fit of the CTF (not used inside relion_refine)");
		EMDL::addLabel(EMDL_CTF_IMAGE, EMDL_STRING, "rlnCtfImage", "Name of an image with all CTF values");
		EMDL::addLabel(EMDL_CTF_LENS_STABILITY, EMDL_RDOUBLE, "rlnLensStability", "Lens stability (in ppm)");
		EMDL::addLabel(EMDL_CTF_MAGNIFICATION, EMDL_RDOUBLE, "rlnMagnification", "Magnification at the detector (in times)");
		EMDL::addLabel(EMDL_CTF_PHASESHIFT, EMDL_RDOUBLE, "rlnPhaseShift", "Phase-shift from a phase-plate (in degrees)");
		EMDL::addLabel(EMDL_CTF_CONVERGENCE_CONE, EMDL_RDOUBLE, "rlnConvergenceCone", "Convergence cone (in mrad)");
		EMDL::addLabel(EMDL_CTF_LONGITUDINAL_DISPLACEMENT, EMDL_RDOUBLE, "rlnLongitudinalDisplacement", "Longitudinal displacement (in Angstroms)");
		EMDL::addLabel(EMDL_CTF_TRANSVERSAL_DISPLACEMENT, EMDL_RDOUBLE, "rlnTransversalDisplacement", "Transversal displacement (in Angstroms)");
		EMDL::addLabel(EMDL_CTF_Q0, EMDL_RDOUBLE, "rlnAmplitudeContrast", "Amplitude contrast (as a fraction, i.e. 10% = 0.1)");
		EMDL::addLabel(EMDL_CTF_VALUE, EMDL_RDOUBLE, "rlnCtfValue", "Value of the Contrast Transfer Function");
		...
		EMDL::addLabel(EMDL_IMAGE_BEAMTILT_X, EMDL_RDOUBLE, "rlnBeamTiltX", "Beam tilt in the X-direction (in mrad)");
		EMDL::addLabel(EMDL_IMAGE_BEAMTILT_Y, EMDL_RDOUBLE, "rlnBeamTiltY", "Beam tilt in the Y-direction (in mrad)");
		...
		EMDL::addLabel(EMDL_IMAGE_ODD_ZERNIKE_COEFFS, EMDL_RDOUBLE_VECTOR, "rlnOddZernike", "Coefficients for the antisymmetrical Zernike polynomials");
		EMDL::addLabel(EMDL_IMAGE_EVEN_ZERNIKE_COEFFS, EMDL_RDOUBLE_VECTOR, "rlnEvenZernike", "Coefficients for the symmetrical Zernike polynomials");
		EMDL::addLabel(EMDL_IMAGE_PIXEL_SIZE, EMDL_RDOUBLE, "rlnImagePixelSize", "Pixel size (in Angstrom)");
		EMDL::addLabel(EMDL_IMAGE_MAG_MATRIX_00, EMDL_RDOUBLE, "rlnMagMat00", "Anisotropic magnification matrix, element 1,1");
		EMDL::addLabel(EMDL_IMAGE_MAG_MATRIX_01, EMDL_RDOUBLE, "rlnMagMat01", "Anisotropic magnification matrix, element 1,2");
		EMDL::addLabel(EMDL_IMAGE_MAG_MATRIX_10, EMDL_RDOUBLE, "rlnMagMat10", "Anisotropic magnification matrix, element 2,1");
		EMDL::addLabel(EMDL_IMAGE_MAG_MATRIX_11, EMDL_RDOUBLE, "rlnMagMat11", "Anisotropic magnification matrix, element 2,2");

		EMDL::addLabel(EMDL_IMAGE_COORD_X, EMDL_RDOUBLE, "rlnCoordinateX", "X-Position of an image in a micrograph (in pixels)");
		EMDL::addLabel(EMDL_IMAGE_COORD_Y, EMDL_RDOUBLE, "rlnCoordinateY", "Y-Position of an image in a micrograph (in pixels)");
		EMDL::addLabel(EMDL_IMAGE_COORD_Z, EMDL_RDOUBLE, "rlnCoordinateZ", "Z-Position of an image in a 3D micrograph, i.e. tomogram (in pixels)");
		EMDL::addLabel(EMDL_IMAGE_FRAME_NR, EMDL_INT, "rlnMovieFrameNumber", "Number of a movie frame");
		EMDL::addLabel(EMDL_IMAGE_NORM_CORRECTION, EMDL_RDOUBLE, "rlnNormCorrection", "Normalisation correction value for an image");
		EMDL::addLabel(EMDL_IMAGE_MAGNIFICATION_CORRECTION, EMDL_RDOUBLE, "rlnMagnificationCorrection", "Magnification correction value for an image");
		EMDL::addLabel(EMDL_IMAGE_SAMPLINGRATE, EMDL_RDOUBLE, "rlnSamplingRate", "Sampling rate of an image (in Angstrom/pixel)");
		EMDL::addLabel(EMDL_IMAGE_SAMPLINGRATE_X, EMDL_RDOUBLE, "rlnSamplingRateX", "Sampling rate in X-direction of an image (in Angstrom/pixel)");
		EMDL::addLabel(EMDL_IMAGE_SAMPLINGRATE_Y, EMDL_RDOUBLE, "rlnSamplingRateY", "Sampling rate in Y-direction of an image (in Angstrom/pixel)");
		EMDL::addLabel(EMDL_IMAGE_SAMPLINGRATE_Z, EMDL_RDOUBLE, "rlnSamplingRateZ", "Sampling rate in Z-direction of an image (in Angstrom/pixel)");
		...
		EMDL::addLabel(EMDL_IMAGE_STATS_MIN, EMDL_RDOUBLE, "rlnMinimumValue", "Minimum value for the pixels in an image");
		EMDL::addLabel(EMDL_IMAGE_STATS_MAX, EMDL_RDOUBLE, "rlnMaximumValue", "Maximum value for the pixels in an image");
		EMDL::addLabel(EMDL_IMAGE_STATS_AVG, EMDL_RDOUBLE, "rlnAverageValue", "Average value for the pixels in an image");
		EMDL::addLabel(EMDL_IMAGE_STATS_STDDEV, EMDL_RDOUBLE, "rlnStandardDeviationValue", "Standard deviation for the pixel values in an image");
		EMDL::addLabel(EMDL_IMAGE_STATS_SKEW, EMDL_RDOUBLE, "rlnSkewnessValue", "Skewness (3rd moment) for the pixel values in an image");
		EMDL::addLabel(EMDL_IMAGE_STATS_KURT, EMDL_RDOUBLE, "rlnKurtosisExcessValue", "Kurtosis excess (4th moment - 3) for the pixel values in an image");
		EMDL::addLabel(EMDL_IMAGE_WEIGHT, EMDL_RDOUBLE, "rlnImageWeight", "Relative weight of an image");
		...
		EMDL::addLabel(EMDL_JOBOPTION_MINVAL, EMDL_RDOUBLE, "rlnJobOptionSliderMin", "Minimum value for slider of a joboption");
		EMDL::addLabel(EMDL_JOBOPTION_MAXVAL, EMDL_RDOUBLE, "rlnJobOptionSliderMax", "Maximum value for slider of a joboption");
		EMDL::addLabel(EMDL_JOBOPTION_STEPVAL, EMDL_RDOUBLE, "rlnJobOptionSliderStep", "Step value for slider of a joboption");
		...
		EMDL::addLabel(EMDL_MATRIX_1_1, EMDL_RDOUBLE, "rlnMatrix_1_1", "Matrix element (1,1) of a 3x3 matrix");
		EMDL::addLabel(EMDL_MATRIX_1_2, EMDL_RDOUBLE, "rlnMatrix_1_2", "Matrix element (1,2) of a 3x3 matrix");
		EMDL::addLabel(EMDL_MATRIX_1_3, EMDL_RDOUBLE, "rlnMatrix_1_3", "Matrix element (1,3) of a 3x3 matrix");
		EMDL::addLabel(EMDL_MATRIX_2_1, EMDL_RDOUBLE, "rlnMatrix_2_1", "Matrix element (2,1) of a 3x3 matrix");
		EMDL::addLabel(EMDL_MATRIX_2_2, EMDL_RDOUBLE, "rlnMatrix_2_2", "Matrix element (2,1) of a 3x3 matrix");
		EMDL::addLabel(EMDL_MATRIX_2_3, EMDL_RDOUBLE, "rlnMatrix_2_3", "Matrix element (2,1) of a 3x3 matrix");
		EMDL::addLabel(EMDL_MATRIX_3_1, EMDL_RDOUBLE, "rlnMatrix_3_1", "Matrix element (3,1) of a 3x3 matrix");
		EMDL::addLabel(EMDL_MATRIX_3_2, EMDL_RDOUBLE, "rlnMatrix_3_2", "Matrix element (3,1) of a 3x3 matrix");
		EMDL::addLabel(EMDL_MATRIX_3_3, EMDL_RDOUBLE, "rlnMatrix_3_3", "Matrix element (3,1) of a 3x3 matrix");

		EMDL::addLabel(EMDL_MICROGRAPH_ACCUM_MOTION_TOTAL, EMDL_RDOUBLE, "rlnAccumMotionTotal","Accumulated global motion during the entire movie (in A)");
		EMDL::addLabel(EMDL_MICROGRAPH_ACCUM_MOTION_EARLY, EMDL_RDOUBLE, "rlnAccumMotionEarly","Accumulated global motion during the first frames of the movie (in A)");
		EMDL::addLabel(EMDL_MICROGRAPH_ACCUM_MOTION_LATE, EMDL_RDOUBLE, "rlnAccumMotionLate","Accumulated global motion during the last frames of the movie (in A)");
		...
		EMDL::addLabel(EMDL_MICROGRAPH_TILT_ANGLE, EMDL_RDOUBLE, "rlnMicrographTiltAngle", "Tilt angle (in degrees) used to collect a micrograph");
		EMDL::addLabel(EMDL_MICROGRAPH_TILT_AXIS_DIRECTION, EMDL_RDOUBLE, "rlnMicrographTiltAxisDirection", "Direction of the tilt-axis (in degrees) used to collect a micrograph");
		EMDL::addLabel(EMDL_MICROGRAPH_TILT_AXIS_OUTOFPLANE, EMDL_RDOUBLE, "rlnMicrographTiltAxisOutOfPlane", "Out-of-plane angle (in degrees) of the tilt-axis used to collect a micrograph (90=in-plane)");
		EMDL::addLabel(EMDL_MICROGRAPH_ORIGINAL_PIXEL_SIZE, EMDL_RDOUBLE, "rlnMicrographOriginalPixelSize", "Pixel size of original movie before binning in Angstrom/pixel.");
		EMDL::addLabel(EMDL_MICROGRAPH_PIXEL_SIZE, EMDL_RDOUBLE, "rlnMicrographPixelSize", "Pixel size of (averaged) micrographs after binning in Angstrom/pixel.");
		EMDL::addLabel(EMDL_MICROGRAPH_PRE_EXPOSURE, EMDL_RDOUBLE, "rlnMicrographPreExposure", "Pre-exposure dose in electrons per square Angstrom");
		EMDL::addLabel(EMDL_MICROGRAPH_DOSE_RATE, EMDL_RDOUBLE, "rlnMicrographDoseRate", "Dose rate in electrons per square Angstrom per frame");
		EMDL::addLabel(EMDL_MICROGRAPH_BINNING, EMDL_RDOUBLE, "rlnMicrographBinning", "Micrograph binning factor");
		...
		EMDL::addLabel(EMDL_MICROGRAPH_SHIFT_X, EMDL_RDOUBLE, "rlnMicrographShiftX", "X shift of a (patch of) micrograph");
		EMDL::addLabel(EMDL_MICROGRAPH_SHIFT_Y, EMDL_RDOUBLE, "rlnMicrographShiftY", "Y shift of a (patch of) micrograph");
		...
		EMDL::addLabel(EMDL_MICROGRAPH_MOTION_COEFF, EMDL_RDOUBLE, "rlnMotionModelCoeff", "A coefficient of a motion model");

		EMDL::addLabel(EMDL_MLMODEL_ACCURACY_ROT, EMDL_RDOUBLE, "rlnAccuracyRotations", "Estimated accuracy (in degrees) with which rotations can be assigned");
		EMDL::addLabel(EMDL_MLMODEL_ACCURACY_TRANS, EMDL_RDOUBLE, "rlnAccuracyTranslations", "Estimated accuracy (in pixels) with which translations can be assigned");
		EMDL::addLabel(EMDL_MLMODEL_ACCURACY_TRANS_ANGSTROM, EMDL_RDOUBLE, "rlnAccuracyTranslationsAngst", "Estimated accuracy (in Angstroms) with which translations can be assigned");
		EMDL::addLabel(EMDL_MLMODEL_AVE_PMAX, EMDL_RDOUBLE, "rlnAveragePmax", "Average value (over all images) of the maxima of the probability distributions");
		EMDL::addLabel(EMDL_MLMODEL_CURRENT_RESOLUTION, EMDL_RDOUBLE, "rlnCurrentResolution", "Current resolution where SSNR^MAP drops below 1 (in 1/Angstroms)");
		EMDL::addLabel(EMDL_MLMODEL_CURRENT_SIZE, EMDL_INT, "rlnCurrentImageSize", "Current size of the images used in the refinement");
		EMDL::addLabel(EMDL_MLMODEL_DATA_VS_PRIOR_REF, EMDL_RDOUBLE, "rlnSsnrMap", "Spectral signal-to-noise ratio as defined for MAP estimation (SSNR^MAP)");
		...
		EMDL::addLabel(EMDL_MLMODEL_DIFF2_HALVES_REF, EMDL_RDOUBLE, "rlnDiff2RandomHalves", "Power of the differences between two independent reconstructions from random halves of the data");
		EMDL::addLabel(EMDL_MLMODEL_ESTIM_RESOL_REF, EMDL_RDOUBLE, "rlnEstimatedResolution", "Estimated resolution (in A) for a reference");
		EMDL::addLabel(EMDL_MLMODEL_FOURIER_COVERAGE_REF, EMDL_RDOUBLE, "rlnFourierCompleteness", "Fraction of Fourier components (per resolution shell) with SNR>1");
		EMDL::addLabel(EMDL_MLMODEL_FOURIER_COVERAGE_TOTAL_REF, EMDL_RDOUBLE, "rlnOverallFourierCompleteness", "Fraction of all Fourier components up to the current resolution with SNR>1");
		EMDL::addLabel(EMDL_MLMODEL_FSC_HALVES_REF, EMDL_RDOUBLE, "rlnGoldStandardFsc", "Fourier shell correlation between two independent reconstructions from random halves of the data");
		...
		EMDL::addLabel(EMDL_MLMODEL_GROUP_SCALE_CORRECTION, EMDL_RDOUBLE, "rlnGroupScaleCorrection", "Intensity-scale correction for a group of images");
		...
		EMDL::addLabel(EMDL_MLMODEL_HELICAL_TWIST, EMDL_RDOUBLE, "rlnHelicalTwist", "The helical twist (rotation per subunit) in degrees");
		EMDL::addLabel(EMDL_MLMODEL_HELICAL_TWIST_MIN, EMDL_RDOUBLE, "rlnHelicalTwistMin", "Minimum helical twist (in degrees, + for right-handedness)");
		EMDL::addLabel(EMDL_MLMODEL_HELICAL_TWIST_MAX, EMDL_RDOUBLE, "rlnHelicalTwistMax", "Maximum helical twist (in degrees, + for right-handedness)");
		EMDL::addLabel(EMDL_MLMODEL_HELICAL_TWIST_INITIAL_STEP, EMDL_RDOUBLE, "rlnHelicalTwistInitialStep", "Initial step of helical twist search (in degrees)");
		EMDL::addLabel(EMDL_MLMODEL_HELICAL_RISE, EMDL_RDOUBLE, "rlnHelicalRise", "The helical rise (translation per subunit) in Angstroms");
		EMDL::addLabel(EMDL_MLMODEL_HELICAL_RISE_MIN, EMDL_RDOUBLE, "rlnHelicalRiseMin", "Minimum helical rise (in Angstroms)");
		EMDL::addLabel(EMDL_MLMODEL_HELICAL_RISE_MAX, EMDL_RDOUBLE, "rlnHelicalRiseMax", "Maximum helical rise (in Angstroms)");
		EMDL::addLabel(EMDL_MLMODEL_HELICAL_RISE_INITIAL_STEP, EMDL_RDOUBLE, "rlnHelicalRiseInitialStep", "Initial step of helical rise search (in Angstroms)");
		...
		EMDL::addLabel(EMDL_MLMODEL_LL, EMDL_RDOUBLE, "rlnLogLikelihood", "Value of the log-likelihood target function");
		...
		EMDL::addLabel(EMDL_MLMODEL_NORM_CORRECTION_AVG, EMDL_RDOUBLE, "rlnNormCorrectionAverage", "Average value (over all images) of the normalisation correction values");
		...
		EMDL::addLabel(EMDL_MLMODEL_ORIENTABILITY_CONTRIBUTION, EMDL_RDOUBLE, "rlnSpectralOrientabilityContribution", "Spectral SNR contribution to the orientability of individual particles");
		EMDL::addLabel(EMDL_MLMODEL_ORIGINAL_SIZE, EMDL_INT, "rlnOriginalImageSize", "Original size of the images (in pixels)");
		EMDL::addLabel(EMDL_MLMODEL_PADDING_FACTOR, EMDL_RDOUBLE, "rlnPaddingFactor", "Oversampling factor for Fourier transforms of the references");
		EMDL::addLabel(EMDL_MLMODEL_PDF_CLASS, EMDL_RDOUBLE, "rlnClassDistribution", "Probability Density Function of the different classes (i.e. fraction of images assigned to each class)");
		EMDL::addLabel(EMDL_MLMODEL_PRIOR_OFFX_CLASS, EMDL_RDOUBLE, "rlnClassPriorOffsetX", "Prior in the X-offset for a class (in pixels)");
		EMDL::addLabel(EMDL_MLMODEL_PRIOR_OFFY_CLASS, EMDL_RDOUBLE, "rlnClassPriorOffsetY", "Prior in the Y-offset for a class (in pixels)");
		EMDL::addLabel(EMDL_MLMODEL_PDF_ORIENT, EMDL_RDOUBLE, "rlnOrientationDistribution", "Probability Density Function of the orientations  (i.e. fraction of images assigned to each orient)");
		EMDL::addLabel(EMDL_MLMODEL_PIXEL_SIZE, EMDL_RDOUBLE, "rlnPixelSize", "Size of the pixels in the references and images (in Angstroms)");
		EMDL::addLabel(EMDL_MLMODEL_POWER_REF, EMDL_RDOUBLE, "rlnReferenceSpectralPower", "Spherical average of the power of the reference");
		...
		EMDL::addLabel(EMDL_MLMODEL_SIGMA_OFFSET, EMDL_RDOUBLE, "rlnSigmaOffsets","Standard deviation in the origin offsets (in pixels)");
		EMDL::addLabel(EMDL_MLMODEL_SIGMA_OFFSET_ANGSTROM, EMDL_RDOUBLE, "rlnSigmaOffsetsAngst","Standard deviation in the origin offsets (in Angstroms)");
		EMDL::addLabel(EMDL_MLMODEL_SIGMA2_NOISE, EMDL_RDOUBLE, "rlnSigma2Noise", "Spherical average of the standard deviation in the noise (sigma)");
		EMDL::addLabel(EMDL_MLMODEL_SIGMA2_REF, EMDL_RDOUBLE, "rlnReferenceSigma2", "Spherical average of the estimated power in the noise of a reference");
		EMDL::addLabel(EMDL_MLMODEL_SIGMA_ROT, EMDL_RDOUBLE, "rlnSigmaPriorRotAngle", "Standard deviation of the prior on the rot (i.e. first Euler) angle");
		EMDL::addLabel(EMDL_MLMODEL_SIGMA_TILT, EMDL_RDOUBLE, "rlnSigmaPriorTiltAngle", "Standard deviation of the prior on the tilt (i.e. second Euler) angle");
		EMDL::addLabel(EMDL_MLMODEL_SIGMA_PSI, EMDL_RDOUBLE, "rlnSigmaPriorPsiAngle", "Standard deviation of the prior on the psi (i.e. third Euler) angle");
		EMDL::addLabel(EMDL_MLMODEL_SSNR_REF, EMDL_RDOUBLE, "rlnSignalToNoiseRatio", "Spectral signal-to-noise ratio for a reference");
		EMDL::addLabel(EMDL_MLMODEL_TAU2_FUDGE_FACTOR, EMDL_RDOUBLE, "rlnTau2FudgeFactor", "Regularisation parameter with which estimates for the power in the references will be multiplied (T in original paper)");
		EMDL::addLabel(EMDL_MLMODEL_TAU2_REF, EMDL_RDOUBLE, "rlnReferenceTau2", "Spherical average of the estimated power in the signal of a reference");

		EMDL::addLabel(EMDL_OPTIMISER_ACCURACY_ROT, EMDL_RDOUBLE, "rlnOverallAccuracyRotations", "Overall accuracy of the rotational assignments (in degrees)");
		EMDL::addLabel(EMDL_OPTIMISER_ACCURACY_TRANS, EMDL_RDOUBLE, "rlnOverallAccuracyTranslations", "Overall accuracy of the translational assignments (in pixels)");
		EMDL::addLabel(EMDL_OPTIMISER_ACCURACY_TRANS_ANGSTROM, EMDL_RDOUBLE, "rlnOverallAccuracyTranslationsAngst", "Overall accuracy of the translational assignments (in Angstroms)");
		EMDL::addLabel(EMDL_OPTIMISER_ADAPTIVE_FRACTION, EMDL_RDOUBLE, "rlnAdaptiveOversampleFraction", "Fraction of the weights that will be oversampled in a second pass of the adaptive oversampling strategy");
		...
		EMDL::addLabel(EMDL_OPTIMISER_AVAILABLE_MEMORY, EMDL_RDOUBLE, "rlnAvailableMemory", "Available memory per computing node (i.e. per MPI-process)");
		EMDL::addLabel(EMDL_OPTIMISER_BEST_RESOL_THUS_FAR, EMDL_RDOUBLE, "rlnBestResolutionThusFar", "The highest resolution that has been obtained in this optimization thus far");
		...
		EMDL::addLabel(EMDL_OPTIMISER_CHANGES_OPTIMAL_OFFSETS, EMDL_RDOUBLE, "rlnChangesOptimalOffsets", "The average change in optimal translation in the last iteration (in pixels) ");
		EMDL::addLabel(EMDL_OPTIMISER_CHANGES_OPTIMAL_ORIENTS, EMDL_RDOUBLE, "rlnChangesOptimalOrientations", "The average change in optimal orientation in the last iteration (in degrees) ");
		EMDL::addLabel(EMDL_OPTIMISER_CHANGES_OPTIMAL_CLASSES, EMDL_RDOUBLE, "rlnChangesOptimalClasses", "The number of particles that changed their optimal clsas assignment in the last iteration");
		...
		EMDL::addLabel(EMDL_OPTIMISER_SGD_INI_RESOL, EMDL_RDOUBLE, "rlnSgdInitialResolution", "Resolution (in A) to use during the initial SGD iterations");
		EMDL::addLabel(EMDL_OPTIMISER_SGD_FIN_RESOL, EMDL_RDOUBLE, "rlnSgdFinalResolution", "Resolution (in A) to use during the final SGD iterations");
		...
		EMDL::addLabel(EMDL_OPTIMISER_SGD_MU, EMDL_RDOUBLE, "rlnSgdMuFactor", "The mu-parameter that controls the momentum of the SGD gradients");
		EMDL::addLabel(EMDL_OPTIMISER_SGD_SIGMA2FUDGE_INI, EMDL_RDOUBLE, "rlnSgdSigma2FudgeInitial", "The variance of the noise will initially be multiplied with this value (larger than 1)");
		...
		EMDL::addLabel(EMDL_OPTIMISER_SGD_STEPSIZE, EMDL_RDOUBLE, "rlnSgdStepsize", "Stepsize in SGD updates)");
		...
		EMDL::addLabel(EMDL_OPTIMISER_HELICAL_TWIST_INITIAL, EMDL_RDOUBLE, "rlnHelicalTwistInitial", "The intial helical twist (rotation per subunit) in degrees before refinement");
		EMDL::addLabel(EMDL_OPTIMISER_HELICAL_RISE_INITIAL, EMDL_RDOUBLE, "rlnHelicalRiseInitial", "The initial helical rise (translation per subunit) in Angstroms before refinement");
		EMDL::addLabel(EMDL_OPTIMISER_HELICAL_Z_PERCENTAGE, EMDL_RDOUBLE, "rlnHelicalCentralProportion", "Only expand this central fraction of the Z axis when imposing real-space helical symmetry");
		EMDL::addLabel(EMDL_OPTIMISER_HELICAL_TUBE_INNER_DIAMETER, EMDL_RDOUBLE, "rlnHelicalMaskTubeInnerDiameter", "Inner diameter of helical tubes in Angstroms (for masks of helical references and particles)");
		EMDL::addLabel(EMDL_OPTIMISER_HELICAL_TUBE_OUTER_DIAMETER, EMDL_RDOUBLE, "rlnHelicalMaskTubeOuterDiameter", "Outer diameter of helical tubes in Angstroms (for masks of helical references and particles)");
		...
		EMDL::addLabel(EMDL_OPTIMISER_HELICAL_SIGMA_DISTANCE, EMDL_RDOUBLE, "rlnHelicalSigmaDistance", "Sigma of distance along the helical tracks");
		...
		EMDL::addLabel(EMDL_OPTIMISER_LOWRES_LIMIT_EXP, EMDL_RDOUBLE, "rlnLowresLimitExpectation", "Low-resolution-limit (in Angstrom) for the expectation step");
		EMDL::addLabel(EMDL_OPTIMISER_HIGHRES_LIMIT_EXP, EMDL_RDOUBLE, "rlnHighresLimitExpectation", "High-resolution-limit (in Angstrom) for the expectation step");
		EMDL::addLabel(EMDL_OPTIMISER_HIGHRES_LIMIT_SGD, EMDL_RDOUBLE, "rlnHighresLimitSGD", "High-resolution-limit (in Angstrom) for Stochastic Gradient Descent");
		...
		EMDL::addLabel(EMDL_OPTIMISER_LOWRES_JOIN_RANDOM_HALVES, EMDL_RDOUBLE, "rlnJoinHalvesUntilThisResolution", "Resolution (in Angstrom) to join the two random half-reconstructions to prevent their diverging orientations (for C-symmetries)");
		EMDL::addLabel(EMDL_OPTIMISER_MAGNIFICATION_RANGE, EMDL_RDOUBLE, "rlnMagnificationSearchRange", "Search range for magnification correction");
		EMDL::addLabel(EMDL_OPTIMISER_MAGNIFICATION_STEP, EMDL_RDOUBLE, "rlnMagnificationSearchStep", "Step size  for magnification correction");
		...
		EMDL::addLabel(EMDL_OPTIMISER_PARTICLE_DIAMETER, EMDL_RDOUBLE, "rlnParticleDiameter", "Diameter of the circular mask to be applied to all experimental images (in Angstroms)");
		...
		EMDL::addLabel(EMDL_OPTIMISER_SMALLEST_CHANGES_OPT_OFFSETS, EMDL_RDOUBLE, "rlnSmallestChangesOffsets", "Smallest changes thus far in the optimal offset assignments (in pixels).");
		EMDL::addLabel(EMDL_OPTIMISER_SMALLEST_CHANGES_OPT_ORIENTS, EMDL_RDOUBLE, "rlnSmallestChangesOrientations", "Smallest changes thus far in the optimal orientation assignments (in degrees).");
		...
		EMDL::addLabel(EMDL_ORIENT_ORIGIN_X, EMDL_RDOUBLE, "rlnOriginX", "X-coordinate (in pixels) for the origin of rotation");
		EMDL::addLabel(EMDL_ORIENT_ORIGIN_Y, EMDL_RDOUBLE, "rlnOriginY", "Y-coordinate (in pixels) for the origin of rotation");
		EMDL::addLabel(EMDL_ORIENT_ORIGIN_Z, EMDL_RDOUBLE, "rlnOriginZ", "Z-coordinate (in pixels) for the origin of rotation");
		EMDL::addLabel(EMDL_ORIENT_ORIGIN_X_PRIOR, EMDL_RDOUBLE, "rlnOriginXPrior", "Center of the prior on the X-coordinate (in pixels) for the origin of rotation");
		EMDL::addLabel(EMDL_ORIENT_ORIGIN_Y_PRIOR, EMDL_RDOUBLE, "rlnOriginYPrior", "Center of the prior on the Y-coordinate (in pixels) for the origin of rotation");
		EMDL::addLabel(EMDL_ORIENT_ORIGIN_Z_PRIOR, EMDL_RDOUBLE, "rlnOriginZPrior", "Center of the prior on the Z-coordinate (in pixels) for the origin of rotation");

		EMDL::addLabel(EMDL_ORIENT_ORIGIN_X_ANGSTROM, EMDL_RDOUBLE, "rlnOriginXAngst", "X-coordinate (in Angstrom) for the origin of rotation");
		EMDL::addLabel(EMDL_ORIENT_ORIGIN_Y_ANGSTROM, EMDL_RDOUBLE, "rlnOriginYAngst", "Y-coordinate (in Angstrom) for the origin of rotation");
		EMDL::addLabel(EMDL_ORIENT_ORIGIN_Z_ANGSTROM, EMDL_RDOUBLE, "rlnOriginZAngst", "Z-coordinate (in Angstrom) for the origin of rotation");
		EMDL::addLabel(EMDL_ORIENT_ORIGIN_X_PRIOR_ANGSTROM, EMDL_RDOUBLE, "rlnOriginXPriorAngst", "Center of the prior on the X-coordinate (in Angstrom) for the origin of rotation");
		EMDL::addLabel(EMDL_ORIENT_ORIGIN_Y_PRIOR_ANGSTROM, EMDL_RDOUBLE, "rlnOriginYPriorAngst", "Center of the prior on the Y-coordinate (in Angstrom) for the origin of rotation");
		EMDL::addLabel(EMDL_ORIENT_ORIGIN_Z_PRIOR_ANGSTROM, EMDL_RDOUBLE, "rlnOriginZPriorAngst", "Center of the prior on the Z-coordinate (in Angstrom) for the origin of rotation");

		EMDL::addLabel(EMDL_ORIENT_ROT, EMDL_RDOUBLE, "rlnAngleRot", "First Euler angle (rot, in degrees)");
		EMDL::addLabel(EMDL_ORIENT_ROT_PRIOR, EMDL_RDOUBLE, "rlnAngleRotPrior", "Center of the prior (in degrees) on the first Euler angle (rot)");
		EMDL::addLabel(EMDL_ORIENT_ROT_PRIOR_FLIP_RATIO, EMDL_RDOUBLE, "rlnAngleRotFlipRatio", "Flip ratio of bimodal rot prior (0~0.5, 0 means an ordinary prior, 0.5 means a perfect bimodal prior)");   // KThurber
		EMDL::addLabel(EMDL_ORIENT_TILT, EMDL_RDOUBLE, "rlnAngleTilt", "Second Euler angle (tilt, in degrees)");
		EMDL::addLabel(EMDL_ORIENT_TILT_PRIOR, EMDL_RDOUBLE, "rlnAngleTiltPrior", "Center of the prior (in degrees) on the second Euler angle (tilt)");
		EMDL::addLabel(EMDL_ORIENT_PSI, EMDL_RDOUBLE, "rlnAnglePsi", "Third Euler, or in-plane angle (psi, in degrees)");
		EMDL::addLabel(EMDL_ORIENT_PSI_PRIOR, EMDL_RDOUBLE, "rlnAnglePsiPrior", "Center of the prior (in degrees) on the third Euler angle (psi)");
		EMDL::addLabel(EMDL_ORIENT_PSI_PRIOR_FLIP_RATIO, EMDL_RDOUBLE, "rlnAnglePsiFlipRatio", "Flip ratio of bimodal psi prior (0~0.5, 0 means an ordinary prior, 0.5 means a perfect bimodal prior)");
		...
		EMDL::addLabel(EMDL_PARTICLE_AUTOPICK_FOM, EMDL_RDOUBLE, "rlnAutopickFigureOfMerit", "Autopicking FOM for a particle");
		EMDL::addLabel(EMDL_PARTICLE_HELICAL_TUBE_ID, EMDL_INT, "rlnHelicalTubeID", "Helical tube ID for a helical segment");
		EMDL::addLabel(EMDL_PARTICLE_HELICAL_TUBE_PITCH, EMDL_RDOUBLE, "rlnHelicalTubePitch", "Cross-over distance for a helical segment (A)");
		EMDL::addLabel(EMDL_PARTICLE_HELICAL_TRACK_LENGTH, EMDL_RDOUBLE, "rlnHelicalTrackLength", "Distance (in pix) from the position of this helical segment to the starting point of the tube");
		EMDL::addLabel(EMDL_PARTICLE_HELICAL_TRACK_LENGTH_ANGSTROM, EMDL_RDOUBLE, "rlnHelicalTrackLengthAngst", "Distance (in A) from the position of this helical segment to the starting point of the tube");
		EMDL::addLabel(EMDL_PARTICLE_CLASS, EMDL_INT, "rlnClassNumber", "Class number for which a particle has its highest probability");
		EMDL::addLabel(EMDL_PARTICLE_DLL, EMDL_RDOUBLE, "rlnLogLikeliContribution", "Contribution of a particle to the log-likelihood target function");
		EMDL::addLabel(EMDL_PARTICLE_ID, EMDL_INT, "rlnParticleId", "ID (i.e. a unique number) for a particle");
		EMDL::addLabel(EMDL_PARTICLE_FOM, EMDL_RDOUBLE, "rlnParticleFigureOfMerit", "Developmental FOM for a particle");
		EMDL::addLabel(EMDL_PARTICLE_KL_DIVERGENCE, EMDL_RDOUBLE, "rlnKullbackLeiblerDivergence", "Kullback-Leibler divergence for a particle");
		...
		EMDL::addLabel(EMDL_PARTICLE_PMAX, EMDL_RDOUBLE, "rlnMaxValueProbDistribution", "Maximum value of the (normalised) probability function for a particle"); /**< particle, Maximum value of probability distribution */
		...
		EMDL::addLabel(EMDL_POSTPROCESS_FINAL_RESOLUTION, EMDL_RDOUBLE, "rlnFinalResolution", "Final estimated resolution after postprocessing (in Angstroms)");
		EMDL::addLabel(EMDL_POSTPROCESS_BFACTOR, EMDL_RDOUBLE, "rlnBfactorUsedForSharpening", "Applied B-factor in the sharpening of the map");
		EMDL::addLabel(EMDL_POSTPROCESS_FRACTION_MOLWEIGHT, EMDL_RDOUBLE, "rlnParticleBoxFractionMolecularWeight", "Fraction of protein voxels in the box, based on ordered molecular weight estimate, for calculating cisTEM-like part_FSC");
		EMDL::addLabel(EMDL_POSTPROCESS_FRACTION_SOLVENT_MASK, EMDL_RDOUBLE, "rlnParticleBoxFractionSolventMask", "Fraction of protein voxels in the box, based on the solvent mask, for calculating cisTEM-like part_FSC");
		EMDL::addLabel(EMDL_POSTPROCESS_FSC_GENERAL, EMDL_RDOUBLE, "rlnFourierShellCorrelation", "FSC value (of unspecified type, e.g. masked or unmasked)");
		EMDL::addLabel(EMDL_POSTPROCESS_FSC_TRUE, EMDL_RDOUBLE, "rlnFourierShellCorrelationCorrected", "Final FSC value: i.e. after correction based on masking of randomized-phases maps");
		EMDL::addLabel(EMDL_POSTPROCESS_FSC_PART_MOLWEIGHT, EMDL_RDOUBLE, "rlnFourierShellCorrelationParticleMolWeight", "CisTEM-like correction of unmasked FSCs, based on ordered molecular weight estimate");
		EMDL::addLabel(EMDL_POSTPROCESS_FSC_PART_FRACMASK, EMDL_RDOUBLE, "rlnFourierShellCorrelationParticleMaskFraction", "CisTEM-like correction of unmasked FSCs, based on fraction of white pixels in solvent mask");
		EMDL::addLabel(EMDL_POSTPROCESS_FSC_MASKED, EMDL_RDOUBLE, "rlnFourierShellCorrelationMaskedMaps", "FSC value after masking of the original maps");
		EMDL::addLabel(EMDL_POSTPROCESS_FSC_UNMASKED, EMDL_RDOUBLE, "rlnFourierShellCorrelationUnmaskedMaps", "FSC value before masking of the original maps");
		EMDL::addLabel(EMDL_POSTPROCESS_FSC_RANDOM_MASKED, EMDL_RDOUBLE, "rlnCorrectedFourierShellCorrelationPhaseRandomizedMaskedMaps", "FSC value after masking of the randomized-phases maps");
		EMDL::addLabel(EMDL_POSTPROCESS_AMPLCORR_MASKED, EMDL_RDOUBLE, "rlnAmplitudeCorrelationMaskedMaps", "Correlation coefficient between amplitudes in Fourier shells of masked maps");
		EMDL::addLabel(EMDL_POSTPROCESS_AMPLCORR_UNMASKED, EMDL_RDOUBLE, "rlnAmplitudeCorrelationUnmaskedMaps", "Correlation coefficient between amplitudes in Fourier shells of unmasked maps");
		EMDL::addLabel(EMDL_POSTPROCESS_DPR_MASKED, EMDL_RDOUBLE, "rlnDifferentialPhaseResidualMaskedMaps", "Differential Phase Residual in Fourier shells of masked maps");
		EMDL::addLabel(EMDL_POSTPROCESS_DPR_UNMASKED,  EMDL_RDOUBLE, "rlnDifferentialPhaseResidualUnmaskedMaps", "Differential Phase Residual in Fourier shells of unmasked maps");
		EMDL::addLabel(EMDL_POSTPROCESS_GUINIER_FIT_INTERCEPT, EMDL_RDOUBLE, "rlnFittedInterceptGuinierPlot", "The fitted intercept of the Guinier-plot");
		EMDL::addLabel(EMDL_POSTPROCESS_GUINIER_FIT_SLOPE, EMDL_RDOUBLE, "rlnFittedSlopeGuinierPlot", "The fitted slope of the Guinier-plot");
		EMDL::addLabel(EMDL_POSTPROCESS_GUINIER_FIT_CORRELATION, EMDL_RDOUBLE, "rlnCorrelationFitGuinierPlot", "The correlation coefficient of the fitted line through the Guinier-plot");
		EMDL::addLabel(EMDL_POSTPROCESS_GUINIER_VALUE_IN, EMDL_RDOUBLE, "rlnLogAmplitudesOriginal", "Y-value for Guinier plot: the logarithm of the radially averaged amplitudes of the input map");
		EMDL::addLabel(EMDL_POSTPROCESS_GUINIER_VALUE_INVMTF, EMDL_RDOUBLE, "rlnLogAmplitudesMTFCorrected", "Y-value for Guinier plot: the logarithm of the radially averaged amplitudes after MTF correction");
		EMDL::addLabel(EMDL_POSTPROCESS_GUINIER_VALUE_WEIGHTED, EMDL_RDOUBLE, "rlnLogAmplitudesWeighted", "Y-value for Guinier plot: the logarithm of the radially averaged amplitudes after FSC-weighting");
		EMDL::addLabel(EMDL_POSTPROCESS_GUINIER_VALUE_SHARPENED, EMDL_RDOUBLE, "rlnLogAmplitudesSharpened", "Y-value for Guinier plot: the logarithm of the radially averaged amplitudes after sharpening");
		EMDL::addLabel(EMDL_POSTPROCESS_GUINIER_VALUE_INTERCEPT, EMDL_RDOUBLE, "rlnLogAmplitudesIntercept", "Y-value for Guinier plot: the fitted plateau of the logarithm of the radially averaged amplitudes");
		EMDL::addLabel(EMDL_POSTPROCESS_GUINIER_RESOL_SQUARED, EMDL_RDOUBLE, "rlnResolutionSquared", "X-value for Guinier plot: squared resolution in 1/Angstrom^2");
		EMDL::addLabel(EMDL_POSTPROCESS_MOLWEIGHT, EMDL_RDOUBLE, "rlnMolecularWeight", "Molecular weight of the ordered mass inside the box for calculating cisTEM-like part.FSC (in kDa)");
		EMDL::addLabel(EMDL_POSTPROCESS_MTF_VALUE, EMDL_RDOUBLE, "rlnMtfValue", "Value of the detectors modulation transfer function (between 0 and 1)");
		EMDL::addLabel(EMDL_POSTPROCESS_RANDOMISE_FROM, EMDL_RDOUBLE, "rlnRandomiseFrom", "Resolution (in A) from which the phases are randomised in the postprocessing step");
		...
		EMDL::addLabel(EMDL_SAMPLING_LIMIT_TILT, EMDL_RDOUBLE, "rlnTiltAngleLimit", "Values to which to limit the tilt angles (positive for keeping side views, negative for keeping top views)");
		EMDL::addLabel(EMDL_SAMPLING_OFFSET_RANGE, EMDL_RDOUBLE, "rlnOffsetRange", "Search range for the origin offsets (in Angstroms)");
		EMDL::addLabel(EMDL_SAMPLING_OFFSET_STEP, EMDL_RDOUBLE, "rlnOffsetStep", "Step size for the searches in the origin offsets (in Angstroms)");
		EMDL::addLabel(EMDL_SAMPLING_OFFSET_RANGE_ORI, EMDL_RDOUBLE, "rlnOffsetRangeOriginal", "Original search range for the origin offsets (in Angstroms)");
		EMDL::addLabel(EMDL_SAMPLING_OFFSET_STEP_ORI, EMDL_RDOUBLE, "rlnOffsetStepOriginal", "Original step size for the searches in the origin offsets (in Angstroms)");
		EMDL::addLabel(EMDL_SAMPLING_HELICAL_OFFSET_STEP, EMDL_RDOUBLE, "rlnHelicalOffsetStep", "Step size for the searches of offsets along helical axis (in Angstroms)");
		EMDL::addLabel(EMDL_SAMPLING_PERTURB, EMDL_RDOUBLE, "rlnSamplingPerturbInstance", "Random instance of the random perturbation on the orientational sampling");
		EMDL::addLabel(EMDL_SAMPLING_PERTURBATION_FACTOR, EMDL_RDOUBLE, "rlnSamplingPerturbFactor", "Factor for random perturbation on the orientational sampling (between 0 no perturbation and 1 very strong perturbation)");
		EMDL::addLabel(EMDL_SAMPLING_PSI_STEP, EMDL_RDOUBLE, "rlnPsiStep", "Step size (in degrees) for the sampling of the in-plane rotation angle (psi)");
		EMDL::addLabel(EMDL_SAMPLING_PSI_STEP_ORI, EMDL_RDOUBLE, "rlnPsiStepOriginal", "Original step size (in degrees) for the sampling of the in-plane rotation angle (psi)");
		...
		EMDL::addLabel(EMDL_SCHEDULE_VAR_FLOAT_VALUE, EMDL_RDOUBLE, "rlnScheduleFloatVariableValue", "Value of a Float variable in the Schedule");
		EMDL::addLabel(EMDL_SCHEDULE_VAR_FLOAT_ORI_VALUE, EMDL_RDOUBLE, "rlnScheduleFloatVariableResetValue", "Value which a Float variable will take upon a reset");
		...
		EMDL::addLabel(EMDL_SELECT_PARTICLES_ZSCORE, EMDL_RDOUBLE, "rlnParticleSelectZScore", "Sum of Z-scores from particle_select. High Z-scores are likely to be outliers.");
		...
		EMDL::addLabel(EMDL_PERFRAME_CUMULATIVE_WEIGHT, EMDL_RDOUBLE, "rlnPerFrameCumulativeWeight", "Sum of the resolution-dependent relative weights from the first frame until the given frame");
		EMDL::addLabel(EMDL_PERFRAME_RELATIVE_WEIGHT, EMDL_RDOUBLE, "rlnPerFrameRelativeWeight", "The resolution-dependent relative weights for a given frame");

		EMDL::addLabel(EMDL_RESOLUTION, EMDL_RDOUBLE, "rlnResolution", "Resolution (in 1/Angstroms)");
		EMDL::addLabel(EMDL_RESOLUTION_ANGSTROM, EMDL_RDOUBLE, "rlnAngstromResolution", "Resolution (in Angstroms)");
		EMDL::addLabel(EMDL_RESOLUTION_INVPIXEL, EMDL_RDOUBLE, "rlnResolutionInversePixel", "Resolution (in 1/pixel, Nyquist = 0.5)");
